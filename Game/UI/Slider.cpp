...
{
	// Determina se lo slider � verticale o orizzontale
	vert = (rect.getHeight() > rect.getWidth());

	// Se il puntatore � rettangolare, dimezza il lato principale
	...
	if (vert)
	{
		// Slider verticale: il valore alto � in alto (quindi invertiamo 1.0f - t)
